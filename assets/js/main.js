...
const ProductVariationSlider = () => {
  ...
  const valueSuffix = widget.valueSuffix && widget.valueSuffix.toLowerCase() || "";
  ...
  const handleCartButtonClick = async e => {
    ...
    setLoading(true);
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_2__["default"].post(window.pvsw.ajaxUrl, qs__WEBPACK_IMPORTED_MODULE_1___default().stringify({
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "mx-2"
  }, minRange), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "range",
    ...
    className: "mx-2"
  }, maxRange)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mb-3 text-xl font-semibold"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, selectedValue), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, " ", valueSuffix)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "mb-6 text-lg"
  }, priceFormatter.format(price)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    className: "bg-[#2C70F6] border-0 !rounded-md uppercase shadow-md",
    onClick: handleCartButtonClick,
    disabled: loading
  }, succeeded && "One moment please.." || loading && "Loading.." || cartButtonText)));
};
render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ProductVariationSlider, null), document.getElementById("product_variation_slider"));
})();
